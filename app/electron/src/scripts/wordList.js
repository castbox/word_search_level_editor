class WordList {
  ...
  createFrequencyIndicator(word) {
    ...
    // BNC-COCA 词频标签
    const bncTag = document.createElement('span');
    bncTag.className = `frequency-tag ${wordInfo.bnc.level}`;
    bncTag.textContent = wordInfo.bnc.levelName;
    bncTag.style.backgroundColor = wordInfo.bnc.color;
    bncTag.title = `BNC-COCA词频: ${wordInfo.bnc.levelName}`;
    
    indicator.appendChild(bncTag);
